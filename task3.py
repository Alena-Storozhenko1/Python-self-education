...
print('Після цього калькулятор застосовує операцію до введених чисел ("перше число" "операція" "друге число") ')
print('і виводить результат на екран.')
...
print('Визначення, чи є серед цифр трьохзначного числа однакові:')
